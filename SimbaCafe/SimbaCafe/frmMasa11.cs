...
namespace SimbaCafe
{
    public partial class frmMasa11 : Form
    {
        public frmMasa11()
        {
            InitializeComponent();
        ...
        private void frmMasa11_Load(object sender, EventArgs e)
        {
            string sorgu = "Select * from masa11";
        ...
        {
            string hesap = "select sum(tutar) from masa11";
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut2 = new NpgsqlCommand("DELETE from masa11", baglanti);
