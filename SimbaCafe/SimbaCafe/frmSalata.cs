...
namespace SimbaCafe
{
    public partial class frmSalata : Form
    {
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut = new NpgsqlCommand("insert into salata (id,ad,fiyat) values (@p1,@p2,@p3)", baglanti);
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut2 = new NpgsqlCommand("DELETE from salata where id=@p1", baglanti);
