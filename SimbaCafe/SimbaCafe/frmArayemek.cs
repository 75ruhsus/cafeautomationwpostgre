...
namespace SimbaCafe
{
    public partial class frmArayemek : Form
    {
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut = new NpgsqlCommand("insert into arayemek (id,ad,fiyat) values (@p1,@p2,@p3)", baglanti);
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut2 = new NpgsqlCommand("DELETE from arayemek where id=@p1", baglanti);
