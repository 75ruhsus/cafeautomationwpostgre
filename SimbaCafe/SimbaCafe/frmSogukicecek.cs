...
namespace SimbaCafe
{
    public partial class frmSogukicecek : Form
    {
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut = new NpgsqlCommand("insert into sogukicecek (id,ad,fiyat) values (@p1,@p2,@p3)", baglanti);
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut2 = new NpgsqlCommand("DELETE from sogukicecek where id=@p1", baglanti);
