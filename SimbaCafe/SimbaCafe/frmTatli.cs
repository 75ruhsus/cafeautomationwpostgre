...
namespace SimbaCafe
{
    public partial class frmTatli : Form
    {
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut = new NpgsqlCommand("insert into tatli (id,ad,fiyat) values (@p1,@p2,@p3)", baglanti);
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut2 = new NpgsqlCommand("DELETE from tatli where id=@p1", baglanti);
