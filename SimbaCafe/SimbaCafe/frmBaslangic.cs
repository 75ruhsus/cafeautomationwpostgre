...
namespace SimbaCafe
{
    public partial class frmBaslangic : Form
    {
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut = new NpgsqlCommand("insert into baslangic (id,ad,fiyat) values (@p1,@p2,@p3)", baglanti);
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut2 = new NpgsqlCommand("DELETE from baslangic where id=@p1", baglanti);
